...
public class ProductServiceImpl implements ProductService{
    ...
    @Override
    public List<ProductResponse> getProductByCategory(Long productCategoryId) { //devuelve todos: activos e inactivos
        return productRepository.getProductByCategory(productCategoryId)
        .stream()
